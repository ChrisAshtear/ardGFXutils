...
int main(int argc, char **argv)
{
	...
	RLE_data g3[41] = {{9, 1},{9, 1},{7, 3},{9, 1},{9, 1},{9, 1},{7, 5},{9, 1},{7, 1},{7, 1},{8, 1},{7, 1},{7, 1},{8, 1},{7, 3},{8, 1},{7, 1},{7, 1},{8, 1},{7, 9},{9, 1},{9, 1},{8, 3},{9, 1},{9, 1},{9, 1},{18, 1},{8, 1},{8, 1},{8, 1},{18, 1},{18, 1},{9, 1},{9, 1},{18, 1},{18, 1},{9, 1},{18, 1},{18, 1},{9, 1},{9, 1}};
	cout << "test" << (int)g3[0].colorIdx;
	delete[] outblock;
